        ...
        <div class="container agency">
            <form method="POST" class="appointment-form" id="appointment-form">
                ...
                <div class="form-group-1">
                    <input type="text" name="title" id="title" placeholder="Agency Name" required />
                ...
                <div class="form-group-2">
                    ...
                    <input type="number" name="number" id="number" placeholder="Registration No" required />
                        ...
                        <option seleected value="">No of trips done</option>
                            <option seleected value="">50 - 100</option>
                            <option value="by_email">100 - 200</option>
                            <option value="by_email">200 - 300</option>
                            <option value="by_email">300 - 400</option>
                            <option value="by_email">400 - 500</option>
                        </select>
                    </div>
